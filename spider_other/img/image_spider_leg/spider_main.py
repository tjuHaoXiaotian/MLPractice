...
from spider_other.img.image_spider_leg import html_downloader
from spider_other.img.image_spider_leg import html_outputer
from spider_other.img.image_spider_leg import html_parser

from spider_other.img.image_spider_leg import datareader
        ...
        for item in self.urls:
            try:
                ...
                if total_download - total_download_pre > 100:
                    print "total download: ", total_download, " failed: ", total_failed, " failed rate: ", total_failed / float(
                        total_download)
...
if __name__ == "__main__":
    csv_url = "list.csv"
    base_dir = "/home/haoxiaotian/data2_leg"
    log_file = "log.txt"
